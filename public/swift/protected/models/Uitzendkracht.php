...
class Uitzendkracht extends CActiveRecord {
   ...
   public function rules() {
      ...
      return array(
          array('EMail', 'unique'),
          array('Naam, Geslacht, GeboorteDatum, Adres, Postcode, Woonplaats, Telefoon, Email, Intecedent_idIntecedent, Vestiging_idVestiging', 'required'),
